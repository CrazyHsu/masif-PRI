...
Created on: 2022-09-20 17:13:16
Last modified: 2022-09-20 17:13:16
'''
...
SECTION_TYPE_LIST_ORIGIN = [DIR_SECTION, SURFEAT_SECTION, MASIFPNISITE_SECTION, MASIFPNISEARCH_SECTION, MASIFPNILIGAND_SECTION]
SECTION_TYPE_LIST_LOWER = [i.lower() for i in SECTION_TYPE_LIST_ORIGIN]

DIR_TAGS = [RAW_PDB_DIR, PDB_CHAIN_DIR, PLY_CHAIN_DIR, TMP_DIR, PLY_FILE_TEMPLATE, EXTRACT_PDB, DEFAULT_PDB_FILE] = \
    ["raw_pdb_dir", "pdb_chain_dir", "ply_chain_dir", "tmp_dir", "ply_file_template", "extract_pdb", "default_pdb_file"]
...
INTEGER_TAGS = [MAX_SHAPE_SIZE, N_CLASSES, N_CONV_LAYERS, N_FEAT]
FLOAT_TAGS = [MESH_RES, RADIUS, MAX_DISTANCE, MAX_SC_FILT, MIN_SC_FILT, POS_SURF_ACCEPT_PROBABILITY,
              ...
              TEST_FRACT]
BOOLEAN_TAGS = [USE_APBS, USE_HBOND, USE_HPHOB, COMPUTE_IFACE, FEATURE_INTERPOLATION]

VALID_TAGS = list(set(DIR_TAGS + SURFEAT_TAGS + MASIFPNISITE_TAGS + MASIFPNISEARCH_TAGS + MASIFPNILIGAND_TAGS))
...
class ParseConfig(object):
    ...
    def instantiate(self):
        ...
        for sec in self.getIds():
            ...
            if sec.lower() == DIR_SECTION.lower() or sec.lower() == SURFEAT_SECTION.lower():
...
class DefaultConfig(object):
    ...
    def getDefaultConfig(self):
        masifpniOpts = {}
        # Default directories
        masifpniOpts["raw_pdb_dir"] = "data_preparation/00-raw_pdbs/"
        masifpniOpts["pdb_chain_dir"] = "data_preparation/01-benchmark_pdbs/"
        masifpniOpts["ply_chain_dir"] = "data_preparation/01-benchmark_surfaces/"
        masifpniOpts["tmp_dir"] = tempfile.gettempdir()
        masifpniOpts["ply_file_template"] = masifpniOpts["ply_chain_dir"] + "/{}.{}_{}.ply"
        masifpniOpts["extract_pdb"] = "data_preparation/extract_pdb/"
        masifpniOpts["default_pdb_file"] = "test_data/default_pdb_file"
        ...
        masifpniOpts["masifpni_search"]["masif_precomputation_dir"] = "data_preparation/04b-precomputation_12A/precomputation/"
        ...
        masifpniOpts["masifpni_site"]["masif_precomputation_dir"] = "data_preparation/04a-precomputation_9A/precomputation/"
        masifpniOpts["masifpni_site"]["range_val_samples"] = 0.9  # 0.9 to 1.0
        masifpniOpts["masifpni_site"]["model_dir"] = "nn_models/all_feat_3l/model_data/"
        masifpniOpts["masifpni_site"]["out_pred_dir"] = "output/all_feat_3l/pred_data/"
        masifpniOpts["masifpni_site"]["out_surf_dir"] = "output/all_feat_3l/pred_surfaces/"
        masifpniOpts["masifpni_site"]["n_feat"] = 5

        # Neural network ligand application specific parameters.
        masifpniOpts["masifpni_ligand"] = {}
        masifpniOpts["masifpni_ligand"]["assembly_dir"] = "data_preparation/00b-pdbs_assembly"
        masifpniOpts["masifpni_ligand"]["ligand_coords_dir"] = "data_preparation/00c-ligand_coords"
        masifpniOpts["masifpni_ligand"]["masif_precomputation_dir"] = "data_preparation/04a-precomputation_12A/precomputation/"
